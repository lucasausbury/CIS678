...
p_C = {}
cursor.execute("SELECT class, p_C FROM Words_stemmed GROUP BY class, p_C")
classes = cursor.fetchall()
for c in classes:
	p_C[c[0]] = math.log(c[1])

# Iterate through each document
cursor.execute("SELECT DISTINCT document FROM Tests_stemmed")
...
for doc in docs:
	...
	sql = "SELECT a.class as actual, b.class, a.count, b.p_wC \
			FROM Tests_stemmed a, Words_stemmed b \
